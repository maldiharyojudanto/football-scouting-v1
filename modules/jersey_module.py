...
def klasifikasi_warna_jersey(imgplayer):
    """
    Daftar warna:
        {0: 'biru',
         1: 'biru muda',
    ...
    kelasprob = int(results[0].probs.top1)

    if kelasprob == 0: # biru
        kelas = (0, 0, 128)
    elif kelasprob == 1: # biru muda
        kelas = (0, 192, 192)
    elif kelasprob == 2: # hijau
        kelas = (0, 128, 0)
    elif kelasprob == 3: # hitam
        kelas = (0, 0, 0)
    elif kelasprob == 4: # kuning
        kelas = (192, 192, 0)
    elif kelasprob == 5: # merah
        kelas = (255, 0, 0)
    elif kelasprob == 6: # putih
        kelas = (255, 255, 255)
    else: # merah muda
        kelas = (192, 0, 192)
